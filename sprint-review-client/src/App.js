        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse">
            <ul className="nav navbar-nav navbar-right navbar-uppercase">
              <li>
                <a href="http://www.creative-tim.com/product/gaia-bootstrap-template-pro" target="_blank" rel="noopener noreferrer">Get PRO Version</a>
              </li>
          ...
          <div className="container">
            <div className="content">
              <div className="title-area">
                <h1 className="title-modern"><Jedi jedi={this.state.jedi}/></h1>
                <div className="separator line-separator">♦</div>
              </div>

              <div className="button-get-started">
                <a href="http://www.creative-tim.com/product/gaia-bootstrap-template" target="_blank" rel="noopener noreferrer" className="btn btn-white btn-fill btn-lg ">
                  Download Demo
                </a>
              </div>
            </div>
